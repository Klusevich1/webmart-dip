      ...
      <nav className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4 lg:gap-8">
          ...
          <div className="hidden md:flex items-center gap-2 shrink-0">
            <a href="https://viber.click/375291828275" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white bg-opacity-20 flex items-center justify-center text-white hover:bg-opacity-30 transition-colors" aria-label="Viber">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M11.4 0C9.473 0 7.504.38 5.712 1.1 3.206 2.1 1.138 3.712 0 5.7.09 7.86.616 9.9 1.4 11.67c.17.38.36.76.55 1.13l-.77 2.85c-.18.65.35 1.27 1.02 1.45.14.04.28.06.42.06.5 0 .98-.25 1.27-.68l.91-1.35c.56.28 1.14.53 1.74.75 1.8.68 3.8 1.04 5.86 1.04.15 0 .3 0 .44-.01 3.57-.02 6.49-2.96 6.49-6.58V6.58C23.9 2.95 20.06 0 15.5 0h-4.1z"/></svg>
            </a>
